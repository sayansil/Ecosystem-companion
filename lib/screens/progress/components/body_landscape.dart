...
class ProgressLandscapeBody extends StatefulWidget {
  final int years;
  final List<SimulationSet> initOrganisms;

  const ProgressLandscapeBody(this.years, this.initOrganisms, {Key? key}): super(key: key);

  @override
  State<ProgressLandscapeBody> createState() => _ProgressLandscapeBodyState();
}

class _ProgressLandscapeBodyState extends State<ProgressLandscapeBody> {
  int currentYear = 0;
