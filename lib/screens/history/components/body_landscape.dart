...
class HistoryLandscapeBody extends StatefulWidget {
  const HistoryLandscapeBody({super.key});

  @override
  State<HistoryLandscapeBody> createState() => _HistoryLandscapeBodyState();
}

class _HistoryLandscapeBodyState extends State<HistoryLandscapeBody> {
