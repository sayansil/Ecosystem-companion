...
class ReportLandscapeBody extends StatefulWidget {
  final String? plotDataPath;

  const ReportLandscapeBody(this.plotDataPath, {Key? key}): super(key: key);

  @override
  State<ReportLandscapeBody> createState() => _ReportLandscapeBodyState();
}

class _ReportLandscapeBodyState extends State<ReportLandscapeBody> {
  bool loading = true;
